    ...
    <div className={`modal-container ${open && "modal-open"}`} onClick={() => {
        ...
        <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form className="edit-form" onSubmit={handleSubmit}>
                ...
                <textarea name="edit-descripcion" id="edit-descripcion" cols="40" rows="4"   value={descripcionEdit} onChange={(e) => setDescripcionEdit(e.target.value)} style={{resize: "none"}}></textarea>
